document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImage() {
        const url = `/api/image/${FILE_ID}/serve?t=${Date.now()}`;
    ...
    function setupCropTool() {
        if (cropRect) { fabricCanvas.remove(cropRect); cropRect = null; }
    ...
    document.getElementById('rotate-left').addEventListener('click', () => {
        fetch(`/api/image/${FILE_ID}/rotate`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    document.getElementById('apply-resize').addEventListener('click', () => {
        ...
        if (!w || !h) return;
        fetch(`/api/image/${FILE_ID}/resize`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    document.getElementById('apply-filters').addEventListener('click', () => {
        ...
        fetch(`/api/image/${FILE_ID}/adjust`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    // Clear drawn objects (keep base image)
